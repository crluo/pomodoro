...
function Pomodoro() {
  ...
  // Whether the app is playing or paused
  const [playPauseToggle, setPlayPauseToggle] = useState("null");
   ...
   */
  function playPause() {
    (playPauseToggle !== "play") ? setPlayPauseToggle(() => "play") : setPlayPauseToggle(() => "pause")
  ...
  return (
    <div className="pomodoro">
          ...
          <div className="float-right">
            <div className="input-group input-group-lg mb-2">
              <span className="input-group-text" data-testid="duration-break">
                {/* displays current break time remaining */}
      ...
      <Session session={session} focusDuration={focusDuration} breakDuration={breakDuration} playPauseToggle={playPauseToggle} progressBar={progressBar} setProgressBar={setProgressBar}/>
    </div>
  );
}
